...
\begin{IEEEkeywords}
post-quantum cryptography, Hyperledger Fabric, permissioned blockchain, quantum threat model, harvest-now-decrypt-later
\end{IEEEkeywords}
...
The audit: (1) enumerates lifecycle cryptographic operations; (2) maps each to
its algorithm and key type; (3) classifies operations as Shor-threatened or
Grover-affected; and (4) assesses severity and exploitability.
...
\begin{figure*}
    \centering
    \includegraphics[width=0.90\linewidth]{figures/fig_ch4_methodology.png}
