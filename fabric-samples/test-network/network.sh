...
function createOrgs() {
  ...
  if [ "$CRYPTO" == "Certificate Authorities" ]; then
    ...
    while [[ $rc -ne 0 && $COUNTER -lt $MAX_RETRY ]]; do
      sleep 1
      set -x
      fabric-ca-client getcainfo -u https://admin:adminpw@localhost:7054 --caname ca-org1 --tls.certfiles "${PWD}/organizations/fabric-ca/org1/tls-cert.pem"
      res=$?
    { set +x; } 2>/dev/null
    rc=$res  # Update rc
    COUNTER=$((COUNTER + 1))
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    ${CONTAINER_CLI} run --rm -v "$(pwd):/data" busybox sh -c 'cd /data && rm -rf organizations/fabric-ca/org1/msp organizations/fabric-ca/org1/tls-cert.pem organizations/fabric-ca/org1/ca-cert.pem organizations/fabric-ca/org1/IssuerPublicKey organizations/fabric-ca/org1/IssuerRevocationPublicKey organizations/fabric-ca/org1/fabric-ca-server.db organizations/fabric-ca/org1/tls-ca-cert.pem organizations/fabric-ca/org1/tls-ca-key.pem organizations/fabric-ca/org1/tls-ca-cert.srl organizations/fabric-ca/org1/caliper-ca-cert.pem organizations/fabric-ca/org1/caliper-ca-key.pem organizations/fabric-ca/org1/caliper-ca-cert.srl'
    ${CONTAINER_CLI} run --rm -v "$(pwd):/data" busybox sh -c 'cd /data && rm -rf organizations/fabric-ca/org2/msp organizations/fabric-ca/org2/tls-cert.pem organizations/fabric-ca/org2/ca-cert.pem organizations/fabric-ca/org2/IssuerPublicKey organizations/fabric-ca/org2/IssuerRevocationPublicKey organizations/fabric-ca/org2/fabric-ca-server.db organizations/fabric-ca/org2/tls-ca-cert.pem organizations/fabric-ca/org2/tls-ca-key.pem organizations/fabric-ca/org2/tls-ca-cert.srl organizations/fabric-ca/org2/caliper-ca-cert.pem organizations/fabric-ca/org2/caliper-ca-key.pem organizations/fabric-ca/org2/caliper-ca-cert.srl'
    ${CONTAINER_CLI} run --rm -v "$(pwd):/data" busybox sh -c 'cd /data && rm -rf organizations/fabric-ca/ordererOrg/msp organizations/fabric-ca/ordererOrg/tls-cert.pem organizations/fabric-ca/ordererOrg/ca-cert.pem organizations/fabric-ca/ordererOrg/IssuerPublicKey organizations/fabric-ca/ordererOrg/IssuerRevocationPublicKey organizations/fabric-ca/ordererOrg/fabric-ca-server.db organizations/fabric-ca/ordererOrg/tls-ca-cert.pem organizations/fabric-ca/ordererOrg/tls-ca-key.pem organizations/fabric-ca/ordererOrg/tls-ca-cert.srl'
