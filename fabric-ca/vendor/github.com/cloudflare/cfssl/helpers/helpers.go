...
// PQCSignatureAlgorithm is a sentinel value returned by SignerAlgo for PQC signers.
// csr.Generate detects this value and builds the CSR using raw ASN.1 instead of
// x509.CreateCertificateRequest, which does not support PQC key types.
const PQCSignatureAlgorithm x509.SignatureAlgorithm = 9999
...
func SignerAlgo(priv crypto.Signer) x509.SignatureAlgorithm {
	...
	default:
		// PQC signers return PQCSignatureAlgorithm as a sentinel
